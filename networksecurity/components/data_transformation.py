...
class DataTransformation:
    def __init__(self,data_validation_artifact:DataValidationArtifact,data_tansformation_config:DataTransformationConfig):
        try:
            self.data_validation_artifact = data_validation_artifact
            self.data_tansformation_config = data_tansformation_config
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            logging.info("starting data transformation so first read test and train data from data validation o/p ")
        except Exception as e:
            raise NetworkSecurityException(e,sys)
